...
//	MessageSource messageSource;
	...
	public String saveCourse(@Valid Course course, BindingResult result,
		...
		model.addAttribute("success", "Course " + course.getInstrument() + " registered successfully");
		return "success";
	}
	...
	public String updateCourse(@Valid Course course, BindingResult result,
		...
		model.addAttribute("success", "Course " + course.getInstrument()	+ " updated successfully");
		return "success";
	}
