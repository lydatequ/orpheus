...
DROP TABLE IF EXISTS `app_courses`;
...
LOCK TABLES `app_courses` WRITE;
/*!40000 ALTER TABLE `app_courses` DISABLE KEYS */;
INSERT INTO `app_courses` VALUES (1,'violin','first'),(2,'violin','second'),(3,'piano','first'),(4,'piano','second'),(5,'drums','first'),(6,'drums','second'),(7,'guitar','first'),(8,'guitar','second'),(9,'saxophone','first'),(10,'saxophone','second');
/*!40000 ALTER TABLE `app_courses` ENABLE KEYS */;
UNLOCK TABLES;
